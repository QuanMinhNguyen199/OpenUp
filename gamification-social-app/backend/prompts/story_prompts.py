...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Dạy user cách từ chối khéo léo nhưng kiên quyết.
...
Lưu ý xưng hô: Bạn coi user là bề trên hoặc ngang hàng, nên xưng Em và gọi User là Anh/Chị. Trong các lựa chọn, user xưng là Tôi hoặc Anh/Chị.""",
...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Dạy user sự kiên nhẫn, tôn trọng kỷ luật.
...
Lưu ý xưng hô: Bạn coi user là học sinh bề dưới, nên xưng Bác và gọi User là Cháu. Trong các lựa chọn, user xưng là Cháu.""",
        'return': STANDARD_RETURN,
...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Dạy user nghệ thuật Lắng Nghe và Đồng Cảm.
...
Lưu ý xưng hô: Bạn coi user là khách hàng quen, xưng Chị và gọi User là Em. Trong các lựa chọn, user xưng là Em.""",
        'return': STANDARD_RETURN,
...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Dạy user tinh thần Đồng Đội, biết hạ cái tôi.
...
Lưu ý xưng hô: Bạn coi user là đồng đội ngang hàng, xưng Tôi và gọi User là Cậu/Ông. Trong các lựa chọn, user xưng là Tôi.""",
        'return': STANDARD_RETURN,
...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Đánh thức lòng Trắc Ẩn và sự Liêm Chính.
...
Lưu ý xưng hô: Bạn coi user là người bề dưới, xưng Cô và gọi User là Cháu. Trong các lựa chọn, user xưng là Cháu.""",
        'return': STANDARD_RETURN,
...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Tôn trọng không gian chung và thấu hiểu áp lực người khác.
...
Lưu ý xưng hô: Bạn coi user là người ngang hàng, xưng Tôi và gọi User là Cậu/Bạn. Trong các lựa chọn, user xưng là Tôi.""",
        'return': STANDARD_RETURN,
...
MỤC TIÊU BÀI HỌC (QUAN TRỌNG): Sự thật mất lòng nhưng giải thoát, giả dối ngọt ngào thì giam cầm.
...
Lưu ý xưng hô: Bạn coi user là người bề dưới, xưng Lão/Ta/Cụ và gọi User là Con/Cháu. Trong các lựa chọn, user xưng là Cháu.""",
        'return': STANDARD_RETURN,

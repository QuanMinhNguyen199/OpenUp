...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.status === "success") {
        ...
        const msg = data.detail || "Đăng ký không thành công";
        setErrorMessage(msg);
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#050505] text-white">
          ...
          <form onSubmit={handleRegister} className="mt-8 space-y-6">
            ...
            <div className="pt-2">
              ...
              <p className="mt-4 text-center text-sm text-gray-500">
                ...
                <Link
                  href="/login"
                  className="font-bold text-[#39FF14] transition-all hover:text-[#00F0FF] hover:underline"
                >
                  Đăng nhập
                </Link>
              </p>
      ...
      {/* Global CSS for animations (Consistent with Login) */}
      <style jsx global>{`

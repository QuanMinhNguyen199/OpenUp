...
export const LESSONS: Record<number, { title: string, content: string }> = {
    1: { title: "Sự Khéo Léo", content: "Học cách từ chối khéo léo những yêu cầu vô lý và sẵn sàng giúp đỡ khi có lý do chính đáng. Sự cả nể không đúng chỗ sẽ làm hại bản thân." },
    2: { title: "Sự Kiên Nhẫn", content: "Tôn trọng nguyên tắc và quy định. Đối mặt với người thi hành công vụ cần sự thành thật, lễ phép và kiên nhẫn giải thích thay vì chống đối hoặc dùng tiền bạc." },
    ...
    6: { title: "Sự Tập Trung", content: "Sự tập trung của mỗi người đều đáng quý. Biết nhận lỗi khi làm ồn và chủ động giúp đỡ người khác là biểu hiện của một văn hóa ứng xử văn minh." },
